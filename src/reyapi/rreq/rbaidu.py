...
__all__ = (
    ...
    'APIRequestBaidu',
    'APIRequestBaiduFanyiLangEnum',
    'APIRequestBaiduFanyiLangAutoEnum',
    'APIRequestBaiduTranslate'
)
...
class APIRequestBaiduFanyiLangEnum(APIRequestBaidu, StrEnum):
    """
    Request Baidu Fanyi APT language enumeration type.
    """
...
class APIRequestBaiduFanyiLangAutoEnum(APIRequestBaidu, StrEnum):
    """
    Request Baidu Fanyi APT language auto type enumeration.
    """

    AUTO = 'auto'


class APIRequestBaiduTranslate(APIRequestBaidu, APIReuqestDatabaseBuild):
    """
    Request Baidu translate API type.
    ...
    LangEnum = APIRequestBaiduFanyiLangEnum
    LangAutoEnum = APIRequestBaiduFanyiLangAutoEnum
    db_names = {
    ...
    def __init__(
        ...
        # Database.
        self.db_record = APIRequestDatabaseRecord(self, 'api', 'baidu_trans')
    ...
    def request(
        self,
        text: str,
        from_lang: APIRequestBaiduFanyiLangEnum | APIRequestBaiduFanyiLangAutoEnum,
        to_lang: APIRequestBaiduFanyiLangEnum
    ) -> FanyiResponse:
        """
    ...
    def get_lang(self, text: str) -> APIRequestBaiduFanyiLangEnum | None:
        """
        ...
        for char in text:
            if char in en_chars:
                return APIRequestBaiduFanyiLangEnum.EN
            elif is_zh(char):
                return APIRequestBaiduFanyiLangEnum.ZH


    def trans(
        self,
        text: str,
        from_lang: APIRequestBaiduFanyiLangEnum | APIRequestBaiduFanyiLangAutoEnum | None = None,
        to_lang: APIRequestBaiduFanyiLangEnum | None = None
    ) -> str:
        """
        Translate.
        ...
        if from_lang is None:
            ...
            from_lang = from_lang or APIRequestBaiduFanyiLangAutoEnum.AUTO
        if to_lang is None:
            if from_lang == APIRequestBaiduFanyiLangEnum.EN:
                to_lang = APIRequestBaiduFanyiLangEnum.ZH
            else:
                to_lang = APIRequestBaiduFanyiLangEnum.EN
